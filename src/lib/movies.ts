...
export const [featuredMovie, ...allMovies]: Movie[] = [
...

  {
    ...
    year: 2004,
    rating: 6.5,
    description: "Quái vật Godzilla trở lại trong trận chiến cuối cùng chống lại các sinh vật ngoài không gian.",
  ...
  // Drama Movies
  {
    ...
    year: 2020,
    rating: 8.0,
    description: "Một câu chuyện về tình yêu cấm đoán, sự chuộc tội và hành trình thoát khỏi địa ngục cá nhân.",
...

  {
    ...
    year: 2026,
    rating: 8.5,
    description: "Bộ phim sâu sắc về mọi hình thái của tình yêu: tình yêu đôi lứa, tình thân gia đình và sự gắn kết bạn bè.",
...

  {
    ...
    year: 2020,
    rating: 7.8,
    description: "Câu chuyện của một phụ nữ lớn tuổi đối mặt với những mâu thuẫn, không ai tin lời kể của bà.",
  ...
  // Comedy Movies
  {
    ...
    year: 2026,
    rating: 7.9,
    description: "George, một người chăn cừu, dạy đàn cừu của mình trở thành thám tử để giải những vụ án bí ẩn trên trang trại.",
...

  {
    ...
    year: 2025,
    rating: 7.5,
    description: "Kevin Hart trở lại với những màn hài hước tươi cười và những khoảnh khắc vô tùy trong show stand-up mới.",
...

  {
    ...
    year: 2024,
    rating: 7.6,
    description: "Tiếp tục những cuộc phiêu lưu thời trang được dự đoán của Andy Sachs trong thế giới ngành hàng hiệu.",
  ...
  // Indie/Art Films
  {
    ...
    year: 2020,
    rating: 6.8,
    description: "Những cơ hội thứ hai bắt đầu khi một tên tội phạm tình cờ gặp một cô bé thông minh và được thiên thần giúp đỡ.",
...

  {
    ...
    year: 2000,
    rating: 6.3,
    description: "Bị mắc kẹt gần đỉnh K2, Annie Garrett cẩn cầu cứu và em trai Peter tập hợp một đội để giải cứu trước khi quá muộn.",
  ...
  // Vietnamese Films
  {
    ...
    year: 2024,
    rating: 7.4,
    description: "Một phim Việt khôi hài về một tiệm thẩm mỹ được điều hành bởi những linh hồn kỳ dị.",
...

  {
    ...
    year: 2024,
    rating: 7.2,
    description: "Một chuyến xe buýt du lịch trở thành cuộc phiêu lưu bất ngờ đầy những bất ngờ hài hước.",
  ...
  // K-dramas
  {
    ...
    year: 2019,
    rating: 7.7,
    description: "Cùng khám phá thế giới riêng của nhóm nhạc K-pop BTS ngoài sân khấu với những cuộc trò chuyện thân mật.",
...

  {
    ...
    year: 2024,
    rating: 7.1,
    description: "Một bộ phim Thái khai thác những bí ẩn từ thế giới tâm linh và các lực lượng thần bí.",
...

  {
    ...
    year: 2020,
    rating: 7.8,
    description: "Gabriel cuối cùng biết sự thật về thân phận của Julia Mitchell, nhưng liệu có quá muộn?",
...
export const actionMovies = allMovies.filter((m) => m.genre.some((g) => ["Hành Động", "Phiêu Lưu"].includes(g)));
export const dramMovies = allMovies.filter((m) => m.genre.some((g) => ["Chính kịch", "Tình Cảm"].includes(g)));
